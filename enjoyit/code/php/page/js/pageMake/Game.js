...
function ShowSentence(arr) {
  ...
  countP.innerHTML = "COUNT : " + parseInt(key + 1) + "/" + ArraySize;
}
...
function GameEnd() {
  ...
  document.getElementById("imet").value = Time.toFixed(1);
  document.getElementById("percent").value = right + "/" + ArraySize;


  console.log(Time.toFixed(1), parseInt(key + 1) + "/" + ArraySize)
